...
public class testdataJson extends TestBase {
    TestBase testBase;
    RestClient restClient;
    //host根url
    String host;            //
    //Excel路径
    String testCaseExcel = "testCase1data.xls"; //j接口数据文件名
    ...
    public void post(HashMap<String, String> data) throws Exception {
        ...
        json = CreatData.initdata(json, "false");
    ...
    public void get(HashMap<String, String> data) throws Exception {
        ...
        json = CreatData.initdata(json, "null");
