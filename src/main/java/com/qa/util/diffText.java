...
public class diffText {
    private static final String FILE_PATH = "C:/Users/Doctor/Desktop/200库.txt"; //参考文本路径
     private static final String COMPARED_FILE_PATH = "C:/Users/Doctor/Desktop/70库.txt";  //需要比较文件的路径
    private static final String RESULT_FILE_PATH = "C:/Users/Doctor/Desktop/200库里有的70库里没有的表.xlsx";  //输入结果比对文件，文件名可以修改
